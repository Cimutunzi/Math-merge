...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2.5-Math-7B/lora/math-merge/random/stage_3_tem_0.7/5.0e-05'
STAGE='3_tem_0.7'
...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${TRAIN_DATA}/Stage_${STAGE}/${adaper_split}/random/5.0e-05
