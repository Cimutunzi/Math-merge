...
MODEL_NAME_OR_PATH='/data/qq/models/Qwen/Qwen2.5-Math-1.5B'
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2.5-Math-1.5B/lora/math-merge/stage_3_tem_0.7/1.0e-07'
STAGE='3_tem_0.7'
...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${TRAIN_DATA}/Stage_${STAGE}/${adaper_split}/1.0e-07
