set -ex
PROMPT_TYPE='direct'
MODEL_NAME_OR_PATH='/data/qq/models/Llama-3-8B-Instruct'
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Llama-3-8B-Instruct/lora/math/stage_3_tem_0.7/checkpoint-800'
STAGE='3_tem_0.7'
adaper_split='checkpoint-800'
...
DATA_NAMES="math"
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/Stage_${STAGE}_${adaper_split}
