...
nohup bash /data/qq/math-evaluation-harness/scripts/llama/math/tem_0.7/stage_3.sh > /data/qq/math-evaluation-harness/log_saves/llama-8b-ins/math/stage_3_0.7.log 2>&1 &
wait $!
