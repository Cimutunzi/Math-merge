...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2.5-Math-7B/lora/math-merge/iter/stage_8_tem_0.7/5.0e-05'
# ======= Base Models =======
...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/iter/stage_8
