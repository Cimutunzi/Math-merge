...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2.5-Math-7B/lora/math-merge/single/stage_2_tem_0.7/5.0e-05'
# ADAPTER_PATH='/data/qq/LLaMA-Factory'
STAGE='2_tem_0.7'
...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${TRAIN_DATA}/Stage_${STAGE}/${adaper_split}/single/5.0e-05
