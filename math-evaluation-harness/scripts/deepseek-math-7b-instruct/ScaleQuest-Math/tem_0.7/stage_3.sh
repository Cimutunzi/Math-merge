...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/deepseek-math-7b-instruct/lora/ScaleQuest-Math/stage_3_tem_0.7/1.0e-04'
STAGE='3_tem_0.7'
...
do
    CUDA_VISIBLE_DEVICES=3 TOKENIZERS_PARALLELISM=false \
