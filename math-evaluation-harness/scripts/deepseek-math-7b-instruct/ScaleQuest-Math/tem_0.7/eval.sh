...
nohup bash /data/qq/math-evaluation-harness/scripts/deepseek/ScaleQuest-Math/tem_0.7/stage_3_1500.sh > /data/qq/math-evaluation-harness/log_saves/deepseek-math-7b-instruct/ScaleQuest-Math/stage_3_0.7_1500.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/deepseek/ScaleQuest-Math/tem_0.7/stage_3.sh > /data/qq/math-evaluation-harness/log_saves/deepseek-math-7b-instruct/ScaleQuest-Math/stage_3_0.7.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/deepseek/ScaleQuest-Math/stage_base.sh > /data/qq/math-evaluation-harness/log_saves/deepseek-math-7b-instruct/ScaleQuest-Math/base.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/deepseek/ScaleQuest-Math/stage_base_3500.sh > /data/qq/math-evaluation-harness/log_saves/deepseek-math-7b-instruct/ScaleQuest-Math/base_3500.log 2>&1 &
# wait $!
