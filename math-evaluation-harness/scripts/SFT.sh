...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen/Qwen2-1.5B-Instruct/lora/gsm8k/SFT'
# adaper_split='checkpoint-300'
...
DATA_NAMES="gsm8k"
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${DATA_NAMES}/SFT
