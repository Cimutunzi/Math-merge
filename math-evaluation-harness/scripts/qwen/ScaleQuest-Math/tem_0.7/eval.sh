...
nohup bash /data/qq/math-evaluation-harness/scripts/qwen/ScaleQuest-Math/tem_0.7/stage_3_2500.sh > /data/qq/math-evaluation-harness/log_saves/Qwen2_1.5b_ins/ScaleQuest-Math/stage_3_0.7_2500.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/qwen/ScaleQuest-Math/tem_0.7/stage_3.sh > /data/qq/math-evaluation-harness/log_saves/Qwen2_1.5b_ins/ScaleQuest-Math/stage_3_0.7.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/qwen/ScaleQuest-Math/stage_base.sh > /data/qq/math-evaluation-harness/log_saves/Qwen2_1.5b_ins/ScaleQuest-Math/base.log 2>&1 &
nohup bash /data/qq/math-evaluation-harness/scripts/qwen/ScaleQuest-Math/stage_base_3500.sh > /data/qq/math-evaluation-harness/log_saves/Qwen2_1.5b_ins/ScaleQuest-Math/base_3500.log 2>&1 &
# wait $!
