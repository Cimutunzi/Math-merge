...
MODEL_NAME_OR_PATH='/data/qq/models/Qwen/Qwen2-7B-Instruct'
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2-7B-Instruct/lora/ScaleQuest-Math/stage_3_tem_0.7/1.0e-04/checkpoint-2500'
STAGE='3_tem_0.7'
adaper_split='checkpoint-2500'
...
DATA_NAMES="math"
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${TRAIN_DATA}/Stage_${STAGE}/${adaper_split}/1.0e-04
