...
ADAPTER_PATH='/data/qq/LLaMA-Factory/saves/Qwen2-7B-Instruct/lora/ScaleQuest-Math/stage_3_tem_0.7/checkpoint-1500'
STAGE='3_tem_0.7'
adaper_split='checkpoint-1500'
...
OUTPUT_DIR=${MODEL_NAME_OR_PATH}/math_eval/${TRAIN_DATA}/Stage_${STAGE}/${adaper_split}
